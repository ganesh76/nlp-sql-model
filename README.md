...
![Banner](https://capsule-render.vercel.app/api?type=waving&color=gradient&height=200&section=header&text=nlp-sql-model&fontSize=80&animation=fadeIn&fontAlignY=35)
